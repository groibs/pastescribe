...
export const ptBr: Dictionary = {
  ...
  admin: {
    ...
    killSwitchesLead: "Chaves globais — cortam chamadas de IA na hora se algo der errado.",
    enableButton: "Ligar",
    disableButton: "Desligar",
    budgetHeading: "Períodos de orçamento",
    budgetLead: "Sem um período configurado, o gratuito fica fail-closed por design — isso é o que destrava.",
    budgetEnvelopeLabel: "Envelope",
    budgetPeriodStartLabel: "Data de início",
    budgetPeriodEndLabel: "Data de fim",
    budgetCapLabel: "Teto (R$)",
    createBudgetButton: "Criar período",
    noBudgetPeriods: "Nenhum período de orçamento configurado ainda.",
    ...
    envelopeIngestion: "Ingestão/processamento",
    envelopeInfra: "Infraestrutura",
